...
router.delete("/image-merchandise/:id", adminController.deleteImageMerchandise);
...
router.delete("/image/:id", adminController.deleteImageItem);

// endpoint imageItem
router.post("/image-item", upload, adminController.addImageItem);
